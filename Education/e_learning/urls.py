...
urlpatterns = [
    ...
    path('my_subjects/<slug>/',student_personal_homepage, name='my_subjects'),
	...
	path('teacher_alerts/<slug>',teacher_alerts,name='teacher_alerts'),
	...
	path('teacher_to_alerts/',teacher_to_alerts, name='teacher_to_alerts'),
