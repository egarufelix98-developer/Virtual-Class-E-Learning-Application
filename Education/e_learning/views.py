...
lista_of_recomends = []
def e_lib(request):
    recommended_math_book = Recommended.objects.filter(subject_name = 'Mathematics')
    recommended_english_book = Recommended.objects.filter(subject_name = 'English')
    recommended_physics_book = Recommended.objects.filter(subject_name = 'Physics')
    recommended_chemistry_book = Recommended.objects.filter(subject_name = 'Chemistry')
    recommended_biology_book = Recommended.objects.filter(subject_name = 'Biology')
    recommended_agric_book = Recommended.objects.filter(subject_name = 'Agriculture')
    recommended_geography_book = Recommended.objects.filter(subject_name = 'Geography')
    recommended_history_book = Recommended.objects.filter(subject_name = 'History')
    recommended_lugbar_book = Recommended.objects.filter(subject_name = 'Lugbara Ti')
    recommended_french_book = Recommended.objects.filter(subject_name = 'French')
    recommended_german_book = Recommended.objects.filter(subject_name = 'German')
    recommended_chinese_book = Recommended.objects.filter(subject_name = 'Chinese')
    ...
    context={
            ...
            'recommended_lugbar_book':recommended_lugbar_book,
    ...
    return render(request,'e_lib.html',context)
...
def Search(request):
    if ('q' in request.GET) and request.GET['q'].strip():
        ...
        print(query_string,'777777777777777777777777777')
